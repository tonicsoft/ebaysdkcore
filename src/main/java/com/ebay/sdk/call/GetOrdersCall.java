 ...
 * one or more order IDs are passed in the request. This value cannot be set back more than 90 days in the past, as this call cannot retrieve sales older than 90 days old.
 * <br>
 ...
 * days. This value cannot be set back more than 90 days in the past, as this call cannot retrieve sales older than 90 days old. ModTimeFrom/ModTimeTo date filters are ignored if the
 ...
 * retrieved. Additional <b>GetOrders</b> calls with higher page numbers or more
 ...
 * Also applicable to <b>Half.com</b> (only returns orders that have not been marked as shipped).
 ...
 * specified in the <b>Pagination.EntriesPerPage</b> input (or the default value, if
 * <b>EntriesPerPage</b> was not specified). This is not necessarily the actual
 * number of orders returned per page (see <b>ReturnedOrderCountActual</b>).
 ...
 * <b>Pagination.PageNumber</b> input. If orders are returned, the first page is 1.
...
public class GetOrdersCall extends com.ebay.sdk.ApiCall
{
   ...
   * orders that meet the request specifications. Orders older than 90 days old will not be returned.
   * 
   * <br>
   * @throws ApiException
   * @throws SdkException
