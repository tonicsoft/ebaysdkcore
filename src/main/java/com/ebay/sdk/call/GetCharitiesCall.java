 ...
 * <br> <B>Input property:</B> <code>Featured</code> - This boolean field is used and set to <code>true</code> if the user wants to search for nonprofit organizations currently featured on the eBay site.
