 ...
 * or both must be included. <b>ItemID</b> is otherwise ignored.
 * <br> <B>Input property:</B> <code>MailMessageType</code> - The type of message. Note that <b>GetMemberMessages</b> does not return
 * messages when this field is set to <b>AskSellerQuestion</b>.
 * <br> <B>Input property:</B> <code>MessageStatus</code> - The status of the message.
 * <br> <B>Input property:</B> <code>DisplayToPublic</code> - If included in the request and set to <code>true</code>, only public messages (viewable
 * in the Item listing) are returned. If omitted or set to <code>false</code> in the
 ...
 * Used for the <b>AskSellerQuestion</b> notification only.
 * <br> <B>Input property:</B> <code>SenderID</code> - An eBay ID that uniquely identifies a user. For
 * <b>GetMemberMessages</b>, this is the sender of the message. If
 ...
 * Note that <b>GetMemberMessages</b> does not return
 * messages when, in the request, the <b>MailMessageType</b> is <b>AskSellerQuestion</b>.
